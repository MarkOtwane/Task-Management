<?php
/**
 * Task Management System - SMTP Mailer Functions
 * Contains only the email sending functions, no API endpoints
 */

// ===== SMTP CONFIGURATION =====// Load environment variables from .env if it exists
